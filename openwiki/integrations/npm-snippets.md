...
description: How the documentation build overlays allowlisted @langchain/docs-sandbox assets into the generated site, how MDX consumes them, and how to verify the package boundary.
